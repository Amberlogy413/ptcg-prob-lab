...
/**
 * 提問 workspace — Phase 2 ships Q1 (Basics & mulligan); the Q2 sentence
 * builder arrives in Phase 3. Defaults to the mulligan-aware view, with the
 * conditioning always visible (non-negotiable #3).
 */
export function AskView() {
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-xs text-ink2">{t("view.ask.q2coming")}</p>
    </div>
  );
}
